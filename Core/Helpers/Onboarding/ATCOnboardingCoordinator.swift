...
class ATCClassicOnboardingCoordinator: ATCOnboardingCoordinatorProtocol, ATCLoginScreenManagerDelegate, ATCPhoneLoginScreenManagerDelegate, ATCSignUpScreenManagerDelegate, ATCPhoneSignUpScreenManagerDelegate, ATCResetPasswordScreenManagerDelegate {
    ...
    init(landingViewModel: ATCLandingScreenViewModel,
        ...
        self.phoneSignUpManager = ATCPhoneSignUpScreenManager(signUpScreen: self.phoneSignUpScreen, viewModel: phoneSignUpViewModel, uiConfig: uiConfig, serverConfig: serverConfig)
        ...
        self.resetPasswordManager = ATCResetPasswordScreenManager(resetPasswordScreen: self.resetPasswordScreen, viewModel: resetPasswordViewModel, uiConfig: uiConfig, serverConfig: serverConfig)
